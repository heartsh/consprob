...
#[inline]
pub fn io_algo_4_prob_mat_pair_on_rna_sta(seq_pair: &SeqPair, seq_len_pair: &(usize, usize), sta_fe_params: &StaFeParams, max_gap_num: usize) -> ProbMatPairOnSta {
  let log_prob_mat_pair_on_sta = io_algo_4_log_prob_mat_pair_on_rna_sta(seq_pair, seq_len_pair, sta_fe_params, max_gap_num);
...
#[inline]
pub fn get_log_sta_ppf_4d_mats(seq_pair: &SeqPair, seq_len_pair: &(usize, usize), sta_fe_params: &StaFeParams, max_gap_num: usize) -> LogPpf4dMat {
